...
2. Перейдите: **Вертикальное многоточие (3 точки сверху справа) > Настройки устройства > Безопасность**
...
Все параметры Security доступны на iOS, iPadOS и macOS: Настройки > Настройки устройства > Безопасность.
