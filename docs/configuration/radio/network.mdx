...
2. Перейдите: **Vertical Ellipsis (3 dots top right) > Radio Configuration > Network**
...
Все параметры Network доступны в iOS, iPadOS и macOS: Settings > Device Configuration > Network.
