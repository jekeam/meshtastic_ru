...
2. Перейдите: **Вертикальное многоточие (3 точки сверху справа) > Radio Configuration > LoRa**
...
:::info информация
Все опции LoRa доступны на iOS, iPadOS и macOS: Settings > Radio Configuration > LoRa.
:::
