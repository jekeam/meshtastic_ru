...
Варианты настроек аудио: Codec2 Enabled, PTT GPIO, Аудио Bitrate/Codec Mode, I2S Word Select, I2S Data IN, I2S Data OUT и I2S Clock. Настройка аудиомодуля отправляется как admin message с protobuf `ConfigModule.Audio`.
...
2. Перейдите: **Вертикальное многоточие (3 точки справа вверху) > Конфигурация радио > Аудио**
