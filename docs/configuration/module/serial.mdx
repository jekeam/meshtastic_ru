---
id: serial
title: Настройки модуля Serial‑порт
sidebar_label: Serial‑порт
...
2. Перейдите: **Вертикальное многоточие (3 точки справа сверху) > Конфигурация радио > Serial**
...
:::info информация
Все настройки модуля Serial доступны на iOS, iPadOS и macOS: Настройки > Конфигурация модуля > Serial.
:::
