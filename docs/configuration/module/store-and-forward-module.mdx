...
title: Настройки модуля Отложенная отправка (Store & Forward)
sidebar_label: Отложенная отправка
...
2. Перейдите: **Вертикальное многоточие (3 dots top right) > Конфигурация радио > Store & Forward**
...
:::info информация
Все настройки модуля Store & Forward доступны на iOS, iPadOS и macOS: Настройки > Конфигурация модуля > Store & Forward.
:::
