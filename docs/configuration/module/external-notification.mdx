...
title: Настройка модуля Внешние уведомления
...
Модуль Внешние уведомления позволяет подключить зуммер, динамик, LED или другое устройство, чтобы оповещать о новых сообщениях из Mesh. Можно включить до 3 пинов независимо друг от друга.

Опции конфигурации Внешние уведомления: Enabled, Active, Alert Bell (General), Alert Bell Vibra, Alert Bell Buzzer, Alert Message (General), Alert Message Vibra, Alert Message Buzzer, Output (General), Output Vibra, Output Buzzer, Output Milliseconds, Use PWM и Nag Timeout. Настройка Внешние уведомления отправляется админ‑сообщением с protobuf `ConfigModule.ExternalNotificationConfig`.
...
## Где доступна настройка модуля Внешние уведомления {#external-notification-module-config-client-availability}
...
Опции Внешние уведомления доступны на Android.

1. Откройте приложение Meshtastic
2. Перейдите: **Вертикальное многоточие (3 точки, справа вверху) > Конфигурация радио > Внешние уведомления**
...
:::info заметка
Все опции модуля внешних уведомлений доступны на iOS, iPadOS и macOS: Настройки > Конфигурация модуля > Внешние уведомления.
:::
...
```shell title="Включить/выключить модуль Внешние уведомления"
...
:::info заметка
Все настройки модуля Внешние уведомления доступны в Web UI.
:::
