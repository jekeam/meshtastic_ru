...
2. Перейдите: **Vertical Ellipsis (3 dots top right) > Radio Configuration > MQTT**
...
Все опции MQTT доступны на iOS, iPadOS и macOS: Settings > Module Configuration > MQTT.
...
Перейдите: Vertical Ellipsis (3 dots top right) > Radio configuration > MQTT. Включите тумблер **MQTT enabled** и нажмите **Send**.
...
Перейдите: Vertical Ellipsis (3 dots top right) > Radio configuration > Channels > LongFast. Включите тумблеры **Uplink enabled** и **Downlink enabled**, затем нажмите **Save** и **Send**.
...
Перейдите: Vertical Ellipsis (3 dots top right) > Radio configuration > Network. Включите тумблер **WiFi enabled**, введите **SSID** и **PSK** своей сети, затем нажмите **Send**.
...
Перейдите в Radio Config > Device > Network: включите тумблер **Enabled** — введите **SSID** и **PSK** своей сети — нажмите значок **Save**.
